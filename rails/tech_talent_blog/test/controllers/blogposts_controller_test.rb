...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { author: @blogpost.author, blog_entry: @blogpost.blog_entry, title: @blogpost.title }
    end
  ...
  test "should update blogpost" do
    patch :update, id: @blogpost, blogpost: { author: @blogpost.author, blog_entry: @blogpost.blog_entry, title: @blogpost.title }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
